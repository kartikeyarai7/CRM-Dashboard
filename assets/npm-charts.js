...
!(function (t, e) {
  ...
  function l(t) {
    var e = t[0] / 255,
      i = t[1] / 255,
      n = t[2] / 255;
    return [100 * (0.4124 * (e = e > 0.04045 ? Math.pow((e + 0.055) / 1.055, 2.4) : e / 12.92) + 0.3576 * (i = i > 0.04045 ? Math.pow((i + 0.055) / 1.055, 2.4) : i / 12.92) + 0.1805 * (n = n > 0.04045 ? Math.pow((n + 0.055) / 1.055, 2.4) : n / 12.92)), 100 * (0.2126 * e + 0.7152 * i + 0.0722 * n), 100 * (0.0193 * e + 0.1192 * i + 0.9505 * n)];
  }
  function d(t) {
    var e = l(t),
      i = e[0],
      n = e[1],
      a = e[2];
    return (n /= 100), (a /= 108.883), (i = (i /= 95.047) > 0.008856 ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116), [116 * (n = n > 0.008856 ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116) - 16, 500 * (i - n), 200 * (n - (a = a > 0.008856 ? Math.pow(a, 1 / 3) : 7.787 * a + 16 / 116))];
  }
  function u(t) {
    var e,
      i,
  ...
  function v(t) {
    var e,
      ...
      r = t[1],
      s = t[2];
    return o <= 8 ? (a = ((i = (100 * o) / 903.3) / 100) * 7.787 + 16 / 116) : ((i = 100 * Math.pow((o + 16) / 116, 3)), (a = Math.pow(i / 100, 1 / 3))), [(e = e / 95.047 <= 0.008856 ? (e = (95.047 * (r / 500 + a - 16 / 116)) / 7.787) : 95.047 * Math.pow(r / 500 + a, 3)), i, (n = n / 108.883 <= 0.008859 ? (n = (108.883 * (a - s / 200 - 16 / 116)) / 7.787) : 108.883 * Math.pow(a - s / 200, 3))];
  }
  function x(t) {
    var e,
      i = t[0],
  ...
  var Z = {
      ...
      easeInOutElastic: function (t) {
        var e = 1.70158,
          i = 0,
          n = 1;
        return 0 === t ? 0 : 2 == (t /= 0.5) ? 1 : (i || (i = 0.45), n < 1 ? ((n = 1), (e = i / 4)) : (e = (i / (2 * Math.PI)) * Math.asin(1 / n)), t < 1 ? n * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * (2 * Math.PI)) / i) * -0.5 : n * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t - e) * (2 * Math.PI)) / i) * 0.5 + 1);
      },
          ...
          if (!(isNaN(i) || i <= 0)) {
            switch ((t.beginPath(), e)) {
              ...
              case "triangle":
                ...
                break;
              case "rectRounded":
                (d = i - (u = 0.516 * i)), (s = Math.cos(h + it) * d), (l = Math.sin(h + it) * d), t.arc(n - s, a - l, u, h - J, h - et), t.arc(n + l, a - s, u, h - et, h), t.arc(n + s, a + l, u, h, h + et), t.arc(n - l, a + s, u, h + et, h + J), t.closePath();
                break;
              case "rect":
                if (!o) {
  ...
  st._set("horizontalBar", { hover: { mode: "index", axis: "y" }, scales: { xAxes: [{ type: "linear", position: "bottom" }], yAxes: [{ type: "category", position: "left", categoryPercentage: 0.8, barPercentage: 0.9, offset: !0, gridLines: { offsetGridLines: !0 } }] }, elements: { rectangle: { borderSkipped: "left" } }, tooltips: { mode: "index", axis: "y" } });
  var Jt = Yt.extend({
      _getValueScaleId: function () {
        return this.getMeta().xAxisID;
      },
  ...
  var ne = Mt.extend({
      ...
      updateBezierControlPoints: function () {
        ...
        else for (t = 0, e = l.length; t < e; ++t) (i = l[t]._model), (n = ut.splineCurve(ut.previousItem(l, t)._model, i, ut.nextItem(l, t)._model, r.tension)), (i.controlPointPreviousX = n.previous.x), (i.controlPointPreviousY = n.previous.y), (i.controlPointNextX = n.next.x), (i.controlPointNextY = n.next.y);
          ...
          if (
            (ut.each(b, function (n, s) {
              if (!ut.isNullOrUndef(n.label)) {
                ...
                if (m) {
                  var V = S + _;
                  W < e.left - 1e-7 && (d = "rgba(0,0,0,0)"), (v = x = w = P = L(r, W, l)), (b = a), (y = o), (A = e.getPixelForTick(s) + C), "top" === f ? ((M = L(r, t.top, F) + F / 2), (I = t.bottom), (O = ((g ? 1 : 0.5) - N) * k), (z = g ? "left" : "center"), (R = e.bottom - V)) : ((M = t.top), (I = L(r, t.bottom, F) - F / 2), (O = (g ? 0 : 0.5) * k), (z = g ? "right" : "center"), (R = e.top + V));
                } else {
                  var E = (p ? 0 : S) + _;
    ...
    draw: function () {
      ...
      if (i.display) {
        var n,
          ...
          c = t.bottom,
          f = t.right;
        (e.fillStyle = ut.valueOrDefault(i.fontColor, st.global.defaultFontColor)), (e.font = r.string), t.isHorizontal() ? ((a = h + (f - h) / 2), (o = u + l), (n = f - h)) : ((a = "left" === i.position ? h + l : f - l), (o = u + (c - u) / 2), (n = c - u), (d = Math.PI * ("left" === i.position ? -0.5 : 0.5))), e.save(), e.translate(a, o), e.rotate(d), (e.textAlign = "center"), (e.textBaseline = "middle");
        var g = i.text;
