...
!(function (a) {
  ...
  (b.prototype = {
        ...
        a
          ...
          .done(
            a.proxy(function (a) {
              ...
              return b === !1 ? (this.error(!1), void this.showForm(!1)) : "string" == typeof b ? (this.error(b), void this.showForm()) : (b && "object" == typeof b && b.hasOwnProperty("newValue") && (c = b.newValue), this.error(!1), (this.value = c), void this.$div.triggerHandler("save", { newValue: c, submitValue: e, response: a }));
            }, this)
          )
          .fail(
            a.proxy(function (a) {
    ...
    (a.fn.editableform.defaults = { type: "text", url: null, params: null, name: null, pk: null, value: null, defaultValue: null, send: "auto", validate: null, success: null, error: null, ajaxOptions: null, showbuttons: !0, scope: null, savenochange: !1 }),
    ...
    (b.prototype = {
      ...
      init: function () {
        ...
        if (((this.options.name = this.options.name || this.$element.attr("id")), (this.options.scope = this.$element[0]), (this.input = a.fn.editableutils.createInput(this.options)), this.input)) {
          switch (
            (void 0 === this.options.value || null === this.options.value ? ((this.value = this.input.html2value(a.trim(this.$element.html()))), (c = !0)) : ((this.options.value = a.fn.editableutils.tryParseJson(this.options.value, !0)), "string" == typeof this.options.value ? (this.value = this.input.str2value(this.options.value)) : (this.value = this.options.value)),
      ...
      option: function (b, c) {
        return b && "object" == typeof b
          ...
          : ((this.options[b] = c), "disabled" === b ? (c ? this.disable() : this.enable()) : ("value" === b && this.setValue(c), this.container && this.container.option(b, c), void (this.input.option && this.input.option(b, c))));
      },
  ...
  (function (a) {
    ...
    (b.prototype = {
      ...
      (a.fn.combodate.defaults = { format: "DD-MM-YYYY HH:mm", template: "D / MMM / YYYY   H : mm", value: null, minYear: 1970, maxYear: new Date().getFullYear(), yearDescending: !0, minuteStep: 5, secondStep: 1, firstItem: "empty", errorClass: null, customClass: "", roundTime: !0, smartDays: !1 });
  })(window.jQuery),
  (function (a) {
    "use strict";
    var b = function (c) {
  ...
  (function (a) {
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
      ...
      (a.fn.editableform.buttons = '<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="fa fa-check" aria-hidden="true"></i></button><button type="button" class="btn btn-default btn-sm editable-cancel"><i class="fa fa-times" aria-hidden="true"></i></button>'),
    ...
    e.prototype = {
      ...
      _process_options: function (b) {
        ...
        c.startDate !== -(1 / 0) && (c.startDate = l.parseDate(c.startDate, e, c.language)),
          c.endDate !== 1 / 0 && (c.endDate = l.parseDate(c.endDate, e, c.language)),
  ...
  (function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      ...
      (b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, { tpl: '<div class="editable-date well"></div>', inputclass: null, format: "yyyy-mm-dd", viewformat: null, datepicker: { weekStart: 0, startView: 0, minViewMode: 0, autoclose: !1 }, clear: "&times; clear" })),
  ...
  (function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.date),
      ...
      (b.defaults = a.extend({}, a.fn.editabletypes.date.defaults, { tpl: '<div class="input-append date"><input type="text"/><span class="add-on"><i class="icon-th"></i></span></div>', inputclass: "input-small", datepicker: { weekStart: 0, startView: 0, minViewMode: 0, autoclose: !0 } })),
  ...
  (function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      ...
      (b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, { tpl: '<div class="editable-date well"></div>', inputclass: null, format: "yyyy-mm-dd hh:ii", formatType: "standard", viewformat: null, datetimepicker: { todayHighlight: !1, autoclose: !1 }, clear: "&times; clear" })),
  ...
  (function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.datetime),
      ...
      (b.defaults = a.extend({}, a.fn.editabletypes.datetime.defaults, { tpl: '<div class="input-append date"><input type="text"/><span class="add-on"><i class="icon-th"></i></span></div>', inputclass: "input-medium", datetimepicker: { todayHighlight: !1, autoclose: !0 } })),
