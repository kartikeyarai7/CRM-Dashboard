  ...
  d.fn.tableExport = function (k) {
    ...
    function E(b, c, e, p, f) {
      if ("function" === typeof f) {
        ...
        if (!1 === l && (0 === a.ignoreRow.length || (-1 === d.inArray(e, a.ignoreRow) && -1 === d.inArray(e - p, a.ignoreRow))) && I(d(b))) {
          b = v(d(b), c);
          var q = b.length,
            h = 0,
            u = 0;
          b.each(function () {
            var b = d(this),
              ...
              l;
            d.each(G, function () {
              if (e > this.s.r && e <= this.e.r && h >= this.s.c && h <= this.e.c) for (l = 0; l <= this.e.c - this.s.c; ++l) q++, u++, f(null, e, h++);
            });
            if (c || a) (a = a || 1), G.push({ s: { r: e, c: h }, e: { r: e + (c || 1) - 1, c: h + a - 1 } });
            !1 === ta(b, q, u++) && f(this, e, h++);
            if (1 < a) for (l = 0; l < a - 1; ++l) u++, f(null, e, h++);
          });
          d.each(G, function () {
            if (e >= this.s.r && e <= this.e.r && h >= this.s.c && h <= this.e.c) for (da = 0; da <= this.e.c - this.s.c; ++da) f(null, e, h++);
          });
        }
      }
    }
    ...
    function wa(b, a, e) {
      ...
      if (0 <= c) {
        for (var d = b.width, l = b.textPos.x, q = a.table.columns.indexOf(a.column), h = 1; h < c; h++) d += a.table.columns[q + h].width;
    ...
    function xa(b, a, e) {
      "undefined" !== typeof b &&
        ...
        (b.hasAttribute("data-tableexport-canvas")
          ? ((a = new Date().getTime()), d(b).attr("data-tableexport-canvas", a), (e.images[a] = { url: '[data-tableexport-canvas="' + a + '"]', src: null }))
          : "undefined" !== a &&
            null != a &&
            a.each(function () {
              if (d(this).is("img")) {
    ...
    function Ka(b, a) {
      function c(b) {
        if (b.url)
          if (b.src) {
            ...
            e.length &&
              ((p = ++f),
              html2canvas(e[0]).then(function (c) {
      ...
      var p = 0,
        f = 0;
      if ("undefined" !== typeof b.images) for (var l in b.images) b.images.hasOwnProperty(l) && c(b.images[l]);
      (b = f) || (a(p), (b = void 0));
      return b;
    }
    function za(b, c, e) {
      c.each(function () {
        ...
        } else d(this).is("img") && ((c = ya(this.src)), ua(b, this, c, e));
      ...
      if ("function" === typeof e.onAutotableText) e.onAutotableText(e.doc, b, c);
        ...
        if (c.length) {
          ...
          for (var q = !1, h = !1; c; ) {
            ...
            !0 !== a.preserve.trailingWS && (u = ma(u) + k);
    ...
    function D(b, c, e, p) {
      ...
      if (null !== b) {
        ...
        if (h && "" !== h && !0 === a.htmlContent) f = d.trim(h);
        else if (h && "" !== h)
    ...
    function N(b, c, d, p, f, l) {
      ...
      if (e)
        try {
          if (((Ea = new Blob([b], { type: d + ";charset=" + p })), saveAs(Ea, c, !1 === l), "function" === typeof a.onAfterSaveToFile)) a.onAfterSaveToFile(b, c);
        } catch (h) {
          ka(c, "data:" + d + (p.length ? ";charset=" + p : "") + (f.length ? ";" + f : "") + ",", l ? "\ufeff" + b : b);
        }
    }
    function ka(b, c, d) {
      ...
      if (!1 !== b && window.navigator.msSaveOrOpenBlob) window.navigator.msSaveOrOpenBlob(new Blob([d]), b);
        ...
        if (f) {
          ...
          "object" === typeof d ? ((window.URL = window.URL || window.webkitURL), (e = []), e.push(d), (l = window.URL.createObjectURL(new Blob(e, { type: c }))), (f.href = l)) : 0 <= c.toLowerCase().indexOf("base64,") ? (f.href = c + L(d)) : (f.href = c + encodeURIComponent(d));
    ...
    function L(a) {
      ...
      for (; p < a.length; ) {
        ...
        d = d + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(l) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(q) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g);
      }
      return d;
    }
    ...
    if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
      ...
      a.tfootSelector.length && qa(d(B).find("tfoot").first().find(a.tfootSelector), "td,th", Y);
      P += "\n";
            ...
            d(a).each(function () {
              ...
              E(this, "td,th", n, c + a.length, function (a, c, l) {
                if (null !== a) {
                  ...
                  a = T(a);
                  d.each(e, function () {
                    if (n >= this.s.r && n <= this.e.r && f >= this.s.c && f <= this.e.c) for (var a = 0; a <= this.e.c - this.s.c; ++a) f++, b++;
                  });
                  if (a || g) (a = a || 1), (g = g || 1), e.push({ s: { r: n, c: f }, e: { r: n + a - 1, c: f + g - 1 } });
                  1 < g && ((h += ' ss:MergeAcross="' + (g - 1) + '"'), (f += g - 1));
      ...
      k = {};
      z = {};
      for (var m, Z, X = 0, da = F.length; X < da; X++) (m = F[X]), (Z = k[m]), (Z = k[m] = null == Z ? 1 : Z + 1), 2 === Z && (F[z[m]] = F[z[m]].substring(0, 29) + "-1"), 1 < k[m] ? (F[X] = F[X].substring(0, 29) + "-" + k[m]) : (z[m] = X);
              ...
              for (k = m = 0; k < y.length; ++k)
                if (((r = y[k]), (t = +J(r) || 1), (l = k + z), !ta(d(r), B, l + (l < m ? m - l : 0)))) {
                  ...
                  if ("" !== d(r).attr("data-tableexport-cellformat")) {
                    ...
                    0 === x && "function" === typeof a.mso.xslx.formatId.numbers && (x = a.mso.xslx.formatId.numbers(d(r), h, k + z));
                  ...
                  if (null != l)
                    if (0 === l.length) v.t = "z";
                      ...
                      else if ("" === A && d(r).find("a").length) (l = "href" !== a.htmlHyperlink ? l : ""), (v = { f: '=HYPERLINK("' + d(r).find("a").attr("href") + (l.length ? '","' + l : "") + '")' });
                      else if ("n" === A || isFinite(Da(l, a.numbers.output))) {
                        if (((r = Da(l, a.numbers.output)), 0 === x && "function" !== typeof a.mso.xslx.formatId.numbers && (x = a.mso.xslx.formatId.numbers), isFinite(r) || isFinite(l))) v = { t: "n", v: isFinite(r) ? r : l, z: "string" === typeof x ? x : x in w ? w[x] : "0.00" };
                      } else if (!1 !== (r = La(l)) || "d" === A) 0 === x && "function" !== typeof a.mso.xslx.formatId.date && (x = a.mso.xslx.formatId.date), (v = { t: "d", v: !1 !== r ? r : l, z: "string" === typeof x ? x : x in w ? w[x] : "m/d/yy" });
                  c[oa({ c: m, r: u })] = v;
                  g.e.c < m && (g.e.c = m);
                  m += t;
                }
      ...
      z = "excel" === k ? "xls" : "doc";
      m = 'xmlns:x="urn:schemas-microsoft-com:office:' + k + '"';
      var H = "",
        ba = "";
      d(B)
        .filter(function () {
        ...
        .each(function () {
          ...
          d(w).each(function () {
            var b = d(this);
            t = "";
            E(this, "td,th", n, r.length + w.length, function (c, g, f) {
              if (null !== c) {
                var e = D(c, g, f),
                  q = "",
                ...
                if (a.mso.styles.length) {
                  ...
                  for (var k in a.mso.styles) (h = g[a.mso.styles[k]]), "" === h && (h = f[a.mso.styles[k]]), "" !== h && "0px none rgb(0, 0, 0)" !== h && "rgba(0, 0, 0, 0)" !== h && ((q += "" === q ? 'style="' : ";"), (q += a.mso.styles[k] + ":" + h));
                }
                t += "<td";
                "" !== q && (t += " " + q + '"');
                q = J(c);
      ...
      m = '<html xmlns:o="urn:schemas-microsoft-com:office:office" ' + m + ' xmlns="http://www.w3.org/TR/REC-html40">' + ('<meta http-equiv="content-type" content="application/vnd.ms-' + k + '; charset=UTF-8">') + "<head>";
      "excel" === k && ((m += "\x3c!--[if gte mso 9]>"), (m += "<xml>"), (m += "<x:ExcelWorkbook>"), (m += "<x:ExcelWorksheets>"), (m += "<x:ExcelWorksheet>"), (m += "<x:Name>"), (m += ba), (m += "</x:Name>"), (m += "<x:WorksheetOptions>"), (m += "<x:DisplayGridlines/>"), a.mso.rtl && (m += "<x:DisplayRightToLeft/>"), (m += "</x:WorksheetOptions>"), (m += "</x:ExcelWorksheet>"), (m += "</x:ExcelWorksheets>"), (m += "</x:ExcelWorkbook>"), (m += "</xml>"), (m += "<![endif]--\x3e"));
      m += "<style>";
      ...
      html2canvas(d(B)[0]).then(function (b) {
        b = b.toDataURL();
        for (var c = atob(b.substring(22)), d = new ArrayBuffer(c.length), g = new Uint8Array(d), f = 0; f < c.length; f++) g[f] = c.charCodeAt(f);
        ...
        Ka(g, function () {
          d(B)
            ...
            .each(function () {
              ...
              if (0 < n)
                for (var e = n - 1; 0 <= e; )
                  d.each(g.headerrows[e], function () {
                    var a = this;
              ...
              d(w).each(function () {
                var a = [];
                b = 0;
                E(this, "td,th", n, r.length + w.length, function (c, e, f) {
              ...
              if ("function" === typeof g.onBeforeAutotable) g.onBeforeAutotable(d(this), g.columns, g.rows, c);
